...
const WORDS = [
    ...
    'ЯКОРЬ', 'ЛАМПА', 'ЗЕРКАЛО', 'ТЮЛЬПАН', 'РОМАШКА', 'ФОНТАН', 'КОРАБЛЬ', 'САМОЛЁТ',
    'КАКТУС', 'АНАНАС', 'АРБУЗ', 'ЧЕРЕПАХА', 'ДЕЛЬФИН', 'ЕДИНОРОГ', 'ФЕНИКС', 'КРЕПОСТЬ',
    'ЛАБИРИНТ', 'СОКРОВИЩЕ', 'КАРУСЕЛЬ', 'ГИТАРА', 'БАРАБАН', 'СКРИПКА', 'ВИШНЯ', 'ПЕРСИК',
    'ЛИМОН', 'МАНДАРИН', 'ШОКОЛАД', 'ПЕЧЕНЬЕ', 'ВАРЕНЬЕ', 'КАРАМЕЛЬ', 'ОБЛЕПИХА', 'МАЛИНА',
    'СНЕЖИНКА', 'СОСУЛЬКА', 'КОСТЁР', 'ПАЛАТКА', 'ГАМАК', 'КАЧЕЛИ', 'ВОЗДУШНЫЙ ШАР',
    'СЕВЕРНОЕ СИЯНИЕ', 'ВОДОПАД', 'АЙСБЕРГ', 'ВЕРШИНА', 'ПЕЩЕРА', 'ДЖУНГЛИ', 'САВАННА'
];
